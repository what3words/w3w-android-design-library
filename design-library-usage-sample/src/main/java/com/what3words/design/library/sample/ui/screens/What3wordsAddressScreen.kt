...
fun What3wordsAddressScreen() {
    Column(
        ...
        What3wordsAddress("filled.count.soap", modifier = Modifier.fillMaxWidth().padding(start = 16.dp))

        What3wordsAddress("congratulations.congratulations.congratulations", modifier = Modifier.fillMaxWidth().padding(start = 16.dp))

        CompositionLocalProvider(LocalLayoutDirection provides androidx.compose.ui.unit.LayoutDirection.Rtl) {
            What3wordsAddress("لبن.درجات.عنق", modifier = Modifier.fillMaxWidth().padding(start = 16.dp))
        }
    }
}